...
const mockData = {
  ...
  stress: {
    ...
    weekly: [
      ...
      { week: 'Week 2', value: 3.8 },
      { week: 'Week 3', value: 3.2 },
      { week: 'Week 4', value: 2.9 },
    ],
    monthly: [
      { month: 'Jan', value: 5.2 },
      { month: 'Feb', value: 4.8 },
  ...
  'mood-detail': {
    daily: [
      { day: 'Sat', happy: 40, calm: 30, focused: 20, stressed: 10 },
      { day: 'Sun', happy: 45, calm: 25, focused: 20, stressed: 10 },
      { day: 'Mon', happy: 30, calm: 20, focused: 30, stressed: 20 },
      { day: 'Tue', happy: 35, calm: 30, focused: 25, stressed: 10 },
      { day: 'Wed', happy: 40, calm: 30, focused: 20, stressed: 10 },
      { day: 'Thu', happy: 45, calm: 25, focused: 25, stressed: 5 },
      { day: 'Fri', happy: 40, calm: 35, focused: 20, stressed: 5 },
    ],
    weekly: [
      { week: 'Week 1', happy: 35, calm: 25, focused: 20, stressed: 20 },
      { week: 'Week 2', happy: 40, calm: 30, focused: 20, stressed: 10 },
      { week: 'Week 3', happy: 45, calm: 30, focused: 15, stressed: 10 },
      { week: 'Week 4', happy: 40, calm: 35, focused: 20, stressed: 5 },
    ],
    monthly: [
      { month: 'Jan', happy: 30, calm: 25, focused: 25, stressed: 20 },
      { month: 'Feb', happy: 35, calm: 30, focused: 20, stressed: 15 },
      { month: 'Mar', happy: 40, calm: 30, focused: 20, stressed: 10 },
      { month: 'Apr', happy: 45, calm: 25, focused: 20, stressed: 10 },
      { month: 'May', happy: 40, calm: 35, focused: 20, stressed: 5 },
    ]
  },
  time: {
    daily: [
      { day: 'Sat', work: 7, exercise: 1, social: 3, learning: 1, selfCare: 2, unknown: 3 },
      { day: 'Sun', work: 2, exercise: 2, social: 5, learning: 2, selfCare: 3, unknown: 2 },
      { day: 'Mon', work: 9, exercise: 1, social: 1, learning: 1, selfCare: 1, unknown: 3 },
      { day: 'Tue', work: 8, exercise: 1, social: 2, learning: 1.5, selfCare: 1.5, unknown: 2 },
      { day: 'Wed', work: 8, exercise: 1, social: 2, learning: 1, selfCare: 1, unknown: 3 },
      { day: 'Thu', work: 7, exercise: 1.5, social: 3, learning: 1, selfCare: 1, unknown: 2.5 },
      { day: 'Fri', work: 6, exercise: 1, social: 4, learning: 0.5, selfCare: 1.5, unknown: 3 },
    ],
    weekly: [
      { week: 'Week 1', work: 40, exercise: 7, social: 14, learning: 8, selfCare: 9, unknown: 14 },
      { week: 'Week 2', work: 42, exercise: 6, social: 12, learning: 10, selfCare: 8, unknown: 14 },
      { week: 'Week 3', work: 38, exercise: 8, social: 15, learning: 7, selfCare: 10, unknown: 14 },
      { week: 'Week 4', work: 35, exercise: 10, social: 18, learning: 8, selfCare: 11, unknown: 10 },
    ],
    monthly: [
      { month: 'Jan', work: 160, exercise: 25, social: 55, learning: 30, selfCare: 35, unknown: 55 },
      { month: 'Feb', work: 155, exercise: 28, social: 58, learning: 32, selfCare: 38, unknown: 49 },
      { month: 'Mar', work: 165, exercise: 30, social: 50, learning: 35, selfCare: 40, unknown: 40 },
      { month: 'Apr', work: 150, exercise: 32, social: 60, learning: 38, selfCare: 45, unknown: 35 },
      { month: 'May', work: 145, exercise: 35, social: 65, learning: 36, selfCare: 44, unknown: 35 },
    ]
  }
};
...
const getTitleForMetric = (metricType: string): string => {
  switch(metricType) {
    ...
    case 'mood-detail': return 'Mood Tracking';
    case 'time': return 'Awake Time Allocation';
    default: return 'Data Trend';
  }
};

const DataTrend: React.FC = () => {
  const { metricType = 'mood' } = useParams<{ metricType: string }>();
      ...
      <div className="px-4 py-5 space-y-6">
        <Card>
          <CardContent className="p-0">
                ...
                {(metricType === 'mood-detail') ? (
                  ...
                  <LineChart data={timeframeData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                    ...
                    <Line 
                      type="monotone" 
                      dataKey="value" 
                      stroke={metricType === 'mood' ? '#9b87f5' : '#a0e4b3'} 
                      strokeWidth={3}
                      dot={{ r: 4 }}
                      activeDot={{ r: 6 }}
                    />
            ...
            {/* Days of week labels */}
            {timeframe === 'day' && (
              <div className="flex justify-between px-8 pb-4 pt-2 text-sm text-muted-foreground">
