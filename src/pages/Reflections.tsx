...
import { PlusCircle, Star, Award, TrendingUp, FileText, BookOpen, Users, Search, Calendar, Globe, ListTodo } from 'lucide-react';
  ...
  return <Layout title="Reflections">
      <div className="px-4 py-5 space-y-10">
        ...
        <section>
          ...
          <div className="space-y-4">
            {reflectionCategories.map((category, index) => <Card key={index} className="border-nirva-soft-peach/30 shadow-sm hover:shadow-md transition-shadow">
                <CardHeader className="pb-2 flex flex-row items-center">
                  {category.icon}
