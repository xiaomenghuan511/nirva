...
const ReflectionTime: React.FC = () => {
  ...
  return <div className="min-h-screen flex flex-col bg-nirva-cream p-6">
        ...
        <div className="w-full mt-12">
          <div className="bg-white rounded-xl p-6 mb-4">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={morningEnabled} onCheckedChange={setMorningEnabled} className="data-[state=checked]:bg-nirva-gold" />
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl p-6">
            <div className="flex items-center justify-between">
              ...
              <Switch checked={eveningEnabled} onCheckedChange={setEveningEnabled} className="data-[state=checked]:bg-nirva-gold" />
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full mt-auto mb-8">
        <Button variant="default" className="w-full rounded-full py-6 bg-nirva-gold hover:bg-nirva-soft-gold text-nirva-neutral-heading flex items-center justify-center gap-2" onClick={() => navigate('/onboarding/loading')}>
          Continue
